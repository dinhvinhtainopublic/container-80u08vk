...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-80u08vk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-80u08vk.containers.anotherwebservice.com/
...
```
git clone git@github.com:dinhvinhtainopublic/container-80u08vk.git
cd container-80u08vk
```
...
```
docker attach container-80u08vk
```
